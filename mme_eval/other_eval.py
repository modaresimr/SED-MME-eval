...
def segment_based_evaluation_df(reference, estimated, meta_df=None, time_resolution=1.):
    ...
    for fname in evaluated_files:
        ...
        segment_based_metric.evaluate(
            reference_event_list=reference_event_list_for_current_file,
            estimated_event_list=estimated_event_list_for_current_file,
            evaluated_length_seconds=None if meta_df is None else meta_df.loc[fname]['duration'] 
        )
